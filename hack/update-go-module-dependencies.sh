...
for x in vendor/github.com/openshift/*; do
	case $x in
		...
		vendor/github.com/openshift/custom-resource-status|vendor/github.com/openshift/assisted-image-service)
			;;
...
go mod edit -replace sigs.k8s.io/cluster-api-provider-ibmcloud=sigs.k8s.io/cluster-api-provider-ibmcloud@v0.9.0-beta.1
